[backend](../README.md) / [Exports](../modules.md) / [prc/channel/channel-user/entities/channeluser.entity](../modules/prc_channel_channel_user_entities_channeluser_entity.md) / ChannelUser
